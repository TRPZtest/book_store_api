...
class BooksController extends AbstractController 
{
    ...
    public function books(
        ...
        $books = $bookRepository->findBy([], ['id' => 'ASC'], $pageSize, ($pageNumber - 1) * $pageSize); //order by id потрібен тому що postgres не створює кластеризований індекс по дефолту, через це змінюється порядок рядків при оновленні данних.
